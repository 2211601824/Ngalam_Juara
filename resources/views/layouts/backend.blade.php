...
>
  <head>
    ...
    <title>Dashboard - Ngalam Juara | System Informasi & Pengadua Keluhan Masyarakat</title>
  ...
  <body>
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        <!-- Menu -->
        @include('layouts.include_back.menu')
        <!-- / Menu -->

        <!-- Layout container -->
        <div class="layout-page">
          <!-- Navbar -->
            @include('layouts.include_back.navbar')
          <!-- / Navbar -->
    ...
    tinymce.init({
        ...
        images_upload_url: '/dashboard/insertartikel',
