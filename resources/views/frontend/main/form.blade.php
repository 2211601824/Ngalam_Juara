      ...
      <div class="row text-white">
        ...
        <div class="col-12 col-lg-6 bg-white shadow p-3">
          <div class="form w-100 pb-2">
            <h4 class="display-3--title mb-5">Lakukan Pelaporan Disini!</h4>
            <form action="{{ url('addpengaduan') }}" method="POST" enctype="multipart/form-data" class="row">
                @csrf
              <div class="col-lg-12 mb-3">
                <input type="text" name="judul" required placeholder="Pelaporan..." id="inputEmail" class="shadow form-control form-control-lg">
              </div>
              <div class="col-lg-12 mb-3">
                <textarea name="deskripsi" required placeholder="Jelaskan Laporan Anda..." id="message" rows="8" class="shadow form-control form-control-lg"></textarea>
              </div>
              <div class="col-lg-12 mb-3">
                <input type="file" name="berkas" required class="shadow form-control form-control-lg">
              </div>
